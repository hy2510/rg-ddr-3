 ...
 */
export function load_audio(url: string | URL, sampling_rate: number): Promise<Float32Array>;
/**
 * @deprecated Use {@link load_audio} instead.
 * @internal
 */
export function read_audio(url: any, sampling_rate: any): Promise<Float32Array<ArrayBufferLike>>;
/**
