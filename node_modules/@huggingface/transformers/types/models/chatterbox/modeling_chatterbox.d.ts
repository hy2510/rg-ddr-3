...
export class ChatterboxModel extends ChatterboxPreTrainedModel {
    ...
    forward({ input_ids, attention_mask, audio_values, exaggeration, position_ids, inputs_embeds, past_key_values, generation_config, logits_processor, num_logits_to_keep, audio_features, audio_tokens, speaker_embeddings, speaker_features, ...kwargs }: {
        [x: string]: any;
        input_ids?: any;
        attention_mask?: any;
        audio_values?: any;
