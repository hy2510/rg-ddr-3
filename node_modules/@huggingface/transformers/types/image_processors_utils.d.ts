...
export class ImageProcessor extends ImageProcessor_base {
     ...
     */
    _call(images: RawImage | RawImage[], ...args: any[]): Promise<ImageProcessorResult>;
}
/**
...
export type ImageProcessorConfig = {
    /**
     * If specified, this function is called during model construction with progress updates.
     */
